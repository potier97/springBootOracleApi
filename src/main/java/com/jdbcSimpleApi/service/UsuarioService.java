package com.jdbcSimpleApi.service;
...
import com.jdbcSimpleApi.model.Usuario;
...
public class UsuarioService {
	...
	public static List<Usuario> obtenerTodos() throws ClassNotFoundException{
		try {
			...
			Connection con = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","SYSTEM","CC123456789");
